...
<div class="well">
    ...
    <fieldset>
        ...
        <section class="col col-6">
            <label class="label">
                Шаблон новости:
                <div class="note">Если обычная отзыв - то выбирайте reviews.</div>
            </label>
                    ...
                    <fieldset>
                        ...
                        <section>
                            ...
                            <label class="input"> <i class="icon-append fa fa-list-alt"></i>
                                {{ Form::text('name['.$locale.']',$review->name) }}
                            </label>
                        </section>
                        <section>
                            <label class="label">Должность отправителя</label>
                            <label class="input"> <i class="icon-append fa fa-list-alt"></i>
                                {{ Form::text('position['.$locale.']',$review->position) }}
                            </label>
                        </section>
                        ...
                        <section>
                            ...
                            <label class="input">
                                {{ ExtForm::image('image',$review->photo()->first()) }}
                            </label>
                        </section>
                        @endif
                        <section>
                            ...
                            <label class="textarea">
                                {{ Form::textarea('content['.$locale.']', $review->content, array('class'=>'redactor redactor_450')) }}
                            </label>
                        </section>
                    </fieldset>
                </div>
